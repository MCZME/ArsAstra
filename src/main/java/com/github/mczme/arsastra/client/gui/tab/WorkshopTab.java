...
import com.github.mczme.arsastra.client.gui.widget.workshop.SequenceStripWidget;
import com.github.mczme.arsastra.client.gui.widget.workshop.SourceFloatingPanel;
...
public class WorkshopTab implements JournalTab, DragHandler {
    ...
    public void init(StarChartJournalScreen screen, int x, int y, int width, int height) {
        ...
        // 工具栏（右上角，书本上方）
        this.toolbar = new WorkshopToolbar(x + width - 70, y - 13, 60, 22, viewModel);
